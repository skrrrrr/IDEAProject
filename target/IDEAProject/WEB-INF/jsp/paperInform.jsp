			...
			<div>
				...
				<ul class="nav navbar-nav navbar-right">
					<%if(person != null )  {%>
						...
						<li><a href="studentInfo.jsp?person_id=<%=person.getPerson_id()%>"><span class="glyphicon glyphicon-user"></span> 查看个人信息</a></li>
				...
				<tr>
					...
					<td>
						...
						<button  type="button" class="btn  btn-success">
            				<span class="glyphicon glyphicon-plus" ></span>查看详细信息
       				 	</button>
       				 	</a>
					</td>
				</tr>   
